...
export const dashboardTranslations: TranslationSet = {
  ...
  'dashboard.welcome.message': {
    en: 'We hope you\'re having a wonderful day. Here\'s your personal dashboard.',
    nl: 'We hopen dat je een geweldige dag hebt. Hier is je persoonlijke dashboard.',
  },
  'dashboard.welcome.callFamily': {
    en: 'Call Family',
    nl: 'Bel Familie',
  },
  'dashboard.welcome.callSupport': {
    en: 'Call Support',
    nl: 'Bel Ondersteuning',
  },
  'dashboard.welcome.emergency': {
    en: 'Emergency',
    nl: 'Noodgeval',
  },
  'dashboard.welcome.newFeatures': {
    en: '3 new features available',
    nl: '3 nieuwe functies beschikbaar',
  },
  'dashboard.welcome.notifications': {
    en: '2 notifications',
    nl: '2 meldingen',
  },
  'dashboard.welcome.systemStatus': {
